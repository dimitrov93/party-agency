  ...
  return (
    <AuthProvider>
      ...
      <Routes>
        ...
        <Route path="/decoration/birthday" element={<Birthday />}></Route>
        <Route path="/decoration/birthday/add" element={<Add />}></Route>

        <Route path="/decoration/baptism" element={<Baptism />}></Route>
        <Route path="/decoration/baptism/add" element={<Add />}></Route>

        <Route path="/decoration/wedding" element={<Wedding />}></Route>
        <Route path="/decoration/wedding/add" element={<Add />}></Route>

        <Route path="/decoration/prom" element={<Prom />}></Route>
        <Route path="/decoration/prom/add" element={<Add />}></Route>

        <Route path="/decoration/anniversary" element={<Anniversary />}></Route>
        <Route path="/decoration/anniversary/add" element={<Add />}></Route>
